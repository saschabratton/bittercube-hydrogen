  ...
  return(
    <section className="relative bg-paper">
      ...
      <div className="container relative text-center">
        ...
        <p className="mb-8 label h4">FOR BAR MANAGERS & BUYERS</p>
        ...
        <p><a href="mailto:info@bittercube.com" className="inline-block">Email us</a> to set up an account and order direct or order wholesale using the portal above.</p>
      </div>
    </section>
  )
}