...
export default function SplitBgVertBlue(){
  return(
    <div className="pt-12 pb-12 bg-dark md:bg-split-dark">
      <div className="relative py-20 border-y-2 border-gold">
        ...
        <div className="container grid grid-cols-1 gap-16 md:grid-cols-2 ">
            ...
            <div className="flex items-center justify-center py-12"><Image src='/images/shop-subscription.jpg' width={370} height={450} className='object-cover h-[30rem] w-96 rounded-2xl ' alt="A cocktail made with Bittercube Bitters" /></div>
        </div>
      </div>
    </div>
  )
