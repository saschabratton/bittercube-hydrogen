            ...
            <dl className="grid gap-8">
              ...
              {links && links.map((link, i) => (
                ...
                <dd key={makeKey(link.linkLabel)}>
                  ...
                  <Link to={link.link} className="flex items-center justify-between w-full gap-2 mx-auto label group">{link.linkLabel} <div className="btn-arrow btn-arrow-gold"></div></Link>
                </dd>
              ))}
            </dl>
          </div>
