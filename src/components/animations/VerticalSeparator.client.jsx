...
// });
  ...
  <>
    <div className="w-0.5 h-full center-absolute hidden md:flex overflow-hidden" id="vertTrigger" >
      <div className="w-0.5 h-full 5 bg-gold path active"></div>
    </div>
    <div className="relative grid w-full grid-cols-2">
      <div className="z-10 flex justify-end overflow-hidden">
        <div className="w-full h-0.5 bg-gold h-path-left active"></div>
        <div className="ornament-arrow ornament-arrow-left active"></div>
      </div>
      <div className="z-10 flex justify-start overflow-hidden">
        <div className="w-full h-0.5 bg-gold h-path-right active"></div>
        <div className="ornament-arrow ornament-arrow-right active"></div>
      </div>
