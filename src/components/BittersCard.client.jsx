...
export default function BittersCard({ bitters }){
  ...
  return(
    <Link to={link} className="flex flex-1 h-full p-6 transition duration-700 border-2 lg:p-12 hover:border-gold border-gold/0 rounded-jumbo-sm">
      <div className="flex flex-col justify-between gap-2 text-center">
        ...
        <div className="flex items-center gap-2 mx-auto label group w-fit">Shop Product<div className="btn-arrow"></div></div>
      </div>
    </Link>
  )
}